    ...
    <section className="about-section" id="about" data-aos="fade-up">
      <div className="container">
        ...
        <p className="about-description" data-aos="fade-up" data-aos-delay="200">
          I'm a passionate Full stack developer skilled in React, JavaScript, HTML, CSS, Nodejs, Expressjs, and MongoDB.
          I love creating stylish and user-friendly web applications with smooth UX.
        </p>
